...
export const metadata: Metadata = {
  title: "All PDF Tools | PagePuff",
  description:
    "A complete list of all the free online PDF tools and resources available on PagePuff.",
};
      ...
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg font-medium text-gray-500">
            ...
            <span className="text-black">PagePuff</span> — all in one place.
          </p>
        </div>
