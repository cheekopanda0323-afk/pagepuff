...
export const privacySections = [
  {
    ...
    content: `PagePuff is designed with privacy as a core principle. We collect minimal information:
...
Unlike other PDF tools, PagePuff processes all files locally in your web browser using JavaScript. This means:
...
PagePuff is not directed at children under the age of 13. We do not knowingly collect personal information from children under 13.
...
**Parental Rights:**
If you are a parent or guardian and believe your child has provided us with personal information, please contact us at hassanamjad3@hotmail.com so we can delete the information.
...
To exercise any of these rights, contact us at: hassanamjad3@hotmail.com`,
  },
  {
    icon: AlertTriangle,
...
- Email: hassanamjad3@hotmail.com
- Website: https://pagepuff.vercel.app/contact`,
  },
];
...
export const termsSections = [
  {
    ...
    content: `By accessing and using PagePuff ("the Service"), you accept and agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our Service.
...
These terms apply to all visitors, users, and others who access or use the Service. We reserve the right to modify these terms at any time. Continued use of the Service after any changes constitutes acceptance of the new terms.`,
  },
  {
    ...
    content: `PagePuff provides free online tools for PDF manipulation, including but not limited to:
...
**Important:** All file processing occurs locally in your web browser. Files are not uploaded to our servers.`,
  },
  {
    ...
    content: `When using PagePuff, you agree to:
...
• We are not responsible for the content of your files`,
  },
  {
    ...
    content: `**Our Content:**
The PagePuff name, logo, and all associated graphics, code, and content are protected by intellectual property laws. You may not copy, modify, or distribute our proprietary content without written permission.
...
**Open Source:**
PagePuff uses various open-source libraries. These libraries retain their respective licenses and attributions.`,
  },
  {
    icon: AlertTriangle,
    title: "5. Disclaimer of Warranties",
    content: `**AS-IS Service:**
PagePuff is provided "AS IS" and "AS AVAILABLE" without warranties of any kind, either express or implied, including but not limited to:
...
To the maximum extent permitted by law, PagePuff and its creators shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to:
...
export const disclaimerSections = [
  {
    ...
    content: `The information provided by PagePuff ("we," "us," or "our") on our website is for general informational purposes only. All information on the site is provided in good faith, however, we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability, or completeness of any information on the site.`,
  },
  {
    icon: Shield,
    title: "No Liability",
  ...
  },
  {
    ...
    content: `PagePuff processes all files locally in your browser. While this provides enhanced privacy, we are not responsible for any data loss, file corruption, or security breaches that may occur on your device or as a result of your browser's configuration.`,
  },
];
