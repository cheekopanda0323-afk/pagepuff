...
export const tools = [
  ...
  { title: "Merge PDF", description: "Combine multiple PDFs into one", icon: Merge, href: "/merge-pdf", category: "organize", iconColor: glass.orange, featured: true },
  { title: "Split PDF", description: "Separate pages into files", icon: Split, href: "/split-pdf", category: "organize", iconColor: glass.orange, featured: true },
  { title: "Compress PDF", description: "Reduce file size instantly", icon: Minimize2, href: "/compress-pdf", category: "optimize", iconColor: glass.green, featured: true },
  { title: "PDF to Word", description: "Convert PDF to Word", icon: FileText, href: "/pdf-to-word", category: "convert", iconColor: glass.blue, featured: true },
  { title: "PDF to PowerPoint", description: "Convert PDF to PPT", icon: Presentation, href: "/pdf-to-powerpoint", category: "convert", iconColor: glass.orange },
  { title: "PDF to Excel", description: "Convert PDF to Excel", icon: FileDown, href: "/pdf-to-excel", category: "convert", iconColor: glass.green },
  { title: "Word to PDF", description: "Convert Word to PDF", icon: FileUp, href: "/word-to-pdf", category: "convert", iconColor: glass.blue, featured: true },
  { title: "PowerPoint to PDF", description: "Convert PPT to PDF", icon: Presentation, href: "/powerpoint-to-pdf", category: "convert", iconColor: glass.orange },
  { title: "Excel to PDF", description: "Convert Excel to PDF", icon: TableIcon, href: "/excel-to-pdf", category: "convert", iconColor: glass.green },
  { title: "Edit PDF", description: "Modify PDF content", icon: Type, href: "/edit-pdf", category: "edit", iconColor: glass.purple },
  { title: "PDF to JPG", description: "Extract images from PDF", icon: FileImage, href: "/pdf-to-jpg", category: "convert", iconColor: glass.green },
  { title: "JPG to PDF", description: "Convert images to PDF", icon: ImagePlus, href: "/jpg-to-pdf", category: "convert", iconColor: glass.yellow, featured: true },
  { title: "Sign PDF", description: "Add digital signature", icon: FileSignature, href: "/sign-pdf", category: "edit", iconColor: glass.blue },
  { title: "Watermark", description: "Add text watermarks", icon: Stamp, href: "/watermark-pdf", category: "edit", iconColor: glass.purple },
  { title: "Rotate PDF", description: "Rotate pages any direction", icon: RotateCw, href: "/rotate-pdf", category: "organize", iconColor: glass.purple },
  { title: "HTML to PDF", description: "Convert webpage to PDF", icon: Globe, href: "/html-to-pdf", category: "convert", iconColor: glass.yellow },
  { title: "Unlock PDF", description: "Remove PDF passwords", icon: Unlock, href: "/unlock-pdf", category: "security", iconColor: glass.blue },
  { title: "Protect PDF", description: "Secure with password", icon: Lock, href: "/protect-pdf", category: "security", iconColor: glass.blue },
  { title: "Organize PDF", description: "Reorder & delete pages", icon: Layers, href: "/organize-pdf", category: "organize", iconColor: glass.orange },
  { title: "Repair PDF", description: "Fix corrupted PDF files", icon: Wrench, href: "/repair-pdf", category: "optimize", iconColor: glass.green },
  { title: "OCR PDF", description: "Extract text from scans", icon: ScanLine, href: "/ocr-pdf", category: "intelligence", iconColor: glass.green },

  // ---- PagePuff-only tools (no iLovePDF equivalent) - appended at the end ----
  { title: "Extract Pages", description: "Extract specific pages from PDF", icon: Scissors, href: "/extract-pages", category: "organize", iconColor: glass.orange },
  { title: "Delete Pages", description: "Remove unwanted pages from PDF", icon: Trash2, href: "/delete-pages", category: "organize", iconColor: glass.orange },
  { title: "Reorder Pages", description: "Change page order of PDF", icon: GripVertical, href: "/reorder-pages", category: "organize", iconColor: glass.orange },
  { title: "Duplicate Pages", description: "Copy pages within the same PDF", icon: Copy, href: "/duplicate-pages", category: "organize", iconColor: glass.orange },
  { title: "Insert Pages", description: "Add pages from other PDFs", icon: PlusCircle, href: "/insert-pages", category: "organize", iconColor: glass.orange },
  { title: "PDF to HTML", description: "Convert PDF to HTML", icon: Globe, href: "/pdf-to-html", category: "convert", iconColor: glass.yellow },
  { title: "Text to PDF", description: "Convert text to PDF", icon: FileText, href: "/text-to-pdf", category: "convert", iconColor: glass.blue },
  { title: "PDF to Text", description: "Extract text from PDF", icon: FileText, href: "/pdf-to-text", category: "convert", iconColor: glass.blue },
  { title: "EPUB to PDF", description: "Convert EPUB to PDF", icon: BookOpen, href: "/epub-to-pdf", category: "convert", iconColor: glass.blue },
  { title: "PDF to EPUB", description: "Convert PDF to EPUB", icon: BookOpen, href: "/pdf-to-epub", category: "convert", iconColor: glass.blue },
  { title: "Edit Metadata", description: "Edit PDF properties", icon: FileText, href: "/edit-metadata", category: "intelligence", iconColor: glass.purple },
];
