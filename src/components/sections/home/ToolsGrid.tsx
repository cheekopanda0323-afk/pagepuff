    ...
    <section id="tools" className="relative overflow-hidden py-24 md:py-32">
      <div className="relative z-10 container mx-auto px-4">
        <div className="scroll-reveal mb-16 text-center">
          <div className="text-primary mb-6 inline-block rounded-full bg-gray-100 px-4 py-1.5 text-sm font-bold tracking-wider uppercase">
            All-In-One Solution
          </div>
        ...
        <div className="stagger-up mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          {featuredTools.map((tool, index) => (
            ...
            >
              <div
                className={`tool-icon ${index === 0 ? "h-20 w-20" : "h-14 w-14"} group-hover:bg-primary mb-6 transition-all duration-500 group-hover:scale-110 group-hover:text-white`}
              >
              ...
              <div className="group-hover:text-primary mt-auto flex items-center pt-6 text-sm font-black tracking-widest text-black/20 uppercase transition-colors">
                Open Tool{" "}
        ...
        <div className="stagger-up grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {displayedOthers.map((tool) => (
            <div key={tool.href} className="h-full">
              ...
              >
                <div className="tool-icon group-hover:bg-primary mb-6 h-14 w-14 transition-all duration-500 group-hover:scale-110 group-hover:text-white">
                ...
                <div className="group-hover:text-primary mt-auto flex items-center pt-6 text-xs font-black tracking-widest text-black/10 uppercase transition-colors">
                  Open Tool{" "}
        ...
        {otherTools.length > 8 && (
          <div className="mt-16 text-center">
            <button
              ...
              className="bg-primary hover:bg-primary-hover group inline-flex items-center gap-2 rounded-full px-10 py-5 text-lg font-bold text-white shadow-2xl transition-all hover:scale-105 active:scale-95"
            >
