...
export function MergePDFClient() {
  ...
  const handleMerge = async () => {
    ...
    try {
      ...
      mergedPdf.setProducer("PagePuff");
      mergedPdf.setCreator("PagePuff");
        ...
        <EducationalContent
          ...
          faqs={[
            ...
            },
            {
              ...
              answer:
                "Yes, PagePuff is unique because it works entirely in your web browser. Your files are never uploaded to any server, making it the most secure way to merge sensitive documents.",
            },
          ]}
        />
      </div>
