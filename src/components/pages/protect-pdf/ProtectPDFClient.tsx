        ...
        <EducationalContent
          howItWorks={{
            ...
            steps: [
              ...
              "PagePuff will encrypt your file using industry-standard protocols. Download the secured version instantly.",
            ],
          }}
          benefits={{
          ...
          faqs={[
            ...
            },
            {
              ...
              answer:
                "Since PagePuff does not store your passwords, we cannot recover them. Please ensure you keep a safe record of your document passwords.",
            },
            {
