          ...
          benefits={{
            ...
            items: [
              ...
              },
              {
                ...
                desc: "Your document and your signature never leave your device. PagePuff is a local tool.",
              },
              {
          ...
          faqs={[
            {
              ...
              answer:
                "PagePuff provides electronic signatures. Depending on your jurisdiction and the type of document, this may or may not satisfy legal requirements for 'qualified' digital signatures.",
            },
            {
