...
const steps = [
  {
    ...
    description:
      "When you select a file, it remains on your device. PagePuff uses WebAssembly and JavaScript to process the file directly in your browser's memory.",
  },
  {
    icon: CloudOff,
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="mx-auto max-w-2xl text-lg text-gray-500">
            PagePuff is built on a &quot;Privacy First&quot; architecture.
